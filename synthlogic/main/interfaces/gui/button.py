...
class Button:
    def __init__(self, parent, value, label, stateCarrier, width=0, height=0, variable=None):
        ...
        self.instance = Radiobutton(parent, value=value, variable=variable, indicatoron=(0 == 0), command=lambda: stateCarrier.saveVal(value), width=width, height=height)
...
class ButtonGroup:
    def __init__(self, parent, startRow=0, startColumn=0):
        ...
        self.selection.set(str(0))

    # creates group of buttons with labels of icons
