...
class Touchpad:
    def __init__(self, parent, width, height, tp_state):
        ...
        self.background = ImageTk.PhotoImage(Image.open('C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\touchpad\\touchpad.gif').resize((width, height)))
        self.canvas.create_image(0, 0, image=self.background, anchor=NW)
        self.cursor = ImageTk.PhotoImage(Image.open('C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\touchpad\\cursor.png'))
    ...
    def setValues(self):
        ...
        #self.synth.valeFrequency.setValue(xValue)
