    ...
    def apply(self, pressed):
        ...
        if pressed:
            ...
            # decay
                ...
                self.asc_level = self.gain - (self.pressed_time - self.attack_phase) / self.decay_phase * (self.gain -(self.gain * self.sustain_level))
            #sustain
            elif self.pressed_time > self.attack_phase + self.decay_phase:
            ...
            self.release_time = time.time() - self.r_start_time
            ...
            if self.desc_level > 0.001 and self.release_phase > 0:
                self.desc_level = (self.release_phase * fraction - self.released_time) / (self.release_phase * fraction) * self.asc_level
