...
def updatePlot():
    ...
    canvas.draw()
    # every 100ms; raise, to improve prefromance; lower, to increase framerate
...
PAD_X_W = 5
PAD_Y_W = 5
background_image = ImageTk.PhotoImage(file='C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\background\\grain.jpg')
touchpad_bg = PhotoImage(file='C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\touchpad\\touchpad.gif')

# Photo by mohammad alizade on Unsplash
# Photo by Pawel Czerwinski on Upsplash
...
sineIcon = PhotoImage(file='C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\waveforms\\Sine.png')
triangleIcon = PhotoImage(file='C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\waveforms\\Triangle.png')
sawtoothIcon = PhotoImage(file='C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\waveforms\\Sawtooth.png')
squareIcon = PhotoImage(file='C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\waveforms\\Square.png')

# === oscillator section
tri = Image.open('C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\waveforms\\Triangle.png')
tri = tri.resize((30, 30))
triR = ImageTk.PhotoImage(tri)
saw = Image.open('C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\waveforms\\Sawtooth.png')
saw = saw.resize((30, 30))
sawR = ImageTk.PhotoImage(saw)
square = Image.open('C:\\Users\\Stally Mugs\\PycharmProjects\\HelloWorld\\pythonProject\\synthlogic\\main\\icons\\waveforms\\Square.png')
square = saw.resize((30, 30))
squareR = ImageTk.PhotoImage(square)
...
oscillator.create([triR, sawR, squareR], OscType.values(), [data.wf_type, data.wf_type, data.wf_type], width=WIDTH_IMG,
                  height=HEIGHT_RB)
...
lfoType.create([triR, sawR, squareR], OscType.values(), [data.lfo_type, data.lfo_type, data.lfo_type], width=WIDTH_IMG,
               height=HEIGHT_RB)
...
sectionMidi.setPosition(FIFTH, SECOND, 1, 1, (0, PAD_X), (0, PAD_Y))
